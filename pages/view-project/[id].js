...
const proj = projectsJSON();
const prod = productsJSON();

export default function ViewProj({ datax }) {
  ...
  const proj = datax.ppj;
  const locs = datax.llc;
  ...
  return (
    <>
    <Head>
        <title>{`HENCHGAL Construction | ${proj?.title}`}</title>
        <meta
          name="description"
      ...
      <main className="home">
        ...
        <section className="view-proj-hero">
          <div className="bg">
            <img src={`/images/${proj?.path?.[0]}`} alt="" />
          </div>
          <div className="container">
            <div className="wrapper">
              <div className="txt">
        ...
        <div className="project-full-inf">
          <div className="container">
            <div className="wrapper">
              <div className="side">
                <div>
                  <h4>Products Used</h4>
                  <ul>
                    {proj?.products?.length !== 0 ? (
                      proj?.products?.map((d, i) => {
                        const x = prod.find((id) => id.uid === d);
                        return (
                          <li>
                            <a href={`/view-product/${d}`}>
                              {x.title}{" "}
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                      ...
                      <li>
                        The products used for this project are not listed yet.
                      </li>
                    )}
                  </ul>
                </div>
                <div>
                  <h4>Date</h4>
                  <p>{proj?.date ? proj.date : "N/A"}</p>
                </div>
                <div>
                  <h4>Duration</h4>
                  <p>{proj?.duration ? proj.duration : "N/A"}</p>
                </div>
                <div>
                  <h4>Location</h4>
                  <p>{proj?.location ? proj.location : "N/A"}</p>
                </div>
              </div>
              <div className="main">
                <div>
                  ...
                  <p>
                    {proj?.fullDesc
                      ? proj.fullDesc
                      : "There is no further description for this project."}
                  </p>
                </div>
